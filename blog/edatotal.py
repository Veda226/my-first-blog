...
category = raw_input("Enter the category for EDA:")
# category="CS"                                          #hardcode (remove it for original code

path = raw_input("Mention the path for category files : ")
# path = "C:\Users\KUMA15\Downloads\Data"                #hardcode (remove it for original code)
...
df = pd.concat((pd.read_csv(f) for f in list_datafiles))     #merges all the files of that category into one
...
pathSave = raw_input("Enter the path where output will be saved : ")
# pathSave= "C:\Users\KUMA15\Downloads\Data\Test"            #hardcode (remove it for original code)
